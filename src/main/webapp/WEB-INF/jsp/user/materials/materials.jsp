        ...
        <div class="header-main">
            ...
            <div class="top-menu">
                <ul>
                    ...
                    <li><a href="<%=basesite%>experiment/showexperiment">实验 </a></li>
                    ...
                    <table class="table">
                        ...
                        <c:forEach items="${materials}" var="material">
                            <tr>
                                ...
                                <td><a class="hvr-bounce-to-right" href="<%=basesite%>file/download?materialsname=${material.materialsname}">下载</a></td>
                            </tr>
                        </c:forEach>
                        </tbody>
                    </table>
